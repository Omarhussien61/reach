...
class _CheckOutPageState extends State<CheckOutPage> {
  ...
  void initState() {
    setState(() {
      Provider.of<Provider_Data>(context, listen: false).address == null
          ? null
          : checkboxValue =
              Provider.of<Provider_Data>(context, listen: false).address.id;
      DefaultAddress =
          Provider.of<Provider_Data>(context, listen: false).address;
    });
    getAddress();
    //getpaymentways();
    super.initState();
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            address == null
                                ...
                                : address.isEmpty
                                    ? Text(
                                        '${getTransrlate(context, 'selectAddressMsg')}')
                                    : ListView.builder(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ListView.builder(
                                          ...
                                          itemCount: widget.carts.items.length,
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  width: ScreenUtil.getWidth(
                                                      ...
                                                      2,
                                                  child: AutoSizeText(
                                                    "${widget.carts.items[index].product.name}",
                                                    maxLines: 2,
                                                    style: TextStyle(
                                                      fontSize: 14,
                                                      fontWeight:
                      ...
                      content: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            ...
                            DefaultAddress == null
                                ? '${getTransrlate(context, 'NoSelect')}'
                                : ' ${DefaultAddress.city == null ? '' : DefaultAddress.city.name ?? ''}.${DefaultAddress.street ?? ''},${DefaultAddress.building ?? ''}${DefaultAddress.apartmentNo ?? ''}',
                            style: TextStyle(
                                height: 1.5, fontWeight: FontWeight.bold),
                          ),
                          Text(
                            ...
                            child: loading
                                ...
                                : InkWell(
                                    onTap: () {
                                      ...
                                      API(context).post('store/checkout/', {
                                        'cart': _cart_model.cart_model.id,
                                        'address': DefaultAddress.id,
                                        'total_cost':
                                            _cart_model.cart_model.grandTotal +
                                                DefaultAddress.total_delivery
                                      }).then((value) {
                    ...
                    Step(
                      ...
                      content: Column(
                        children: <Widget>[
                          ...
                          Text(
                            "${getTransrlate(context, 'NoteCheckout')}",
                            style: TextStyle(
                                color: Colors.grey,
                                fontWeight: FontWeight.bold,
                                fontSize: 14),
    ...
    DefaultAddress == null
        ? showDialog(
            ...
            builder: (_) => ResultOverlay(
                '${getTransrlate(context, 'selectAddressPopupMsg')}'))
        : _currentStep < 2
  ...
  Future<void> getAddress() async {
    ...
    API(context)
        .get('account/api/address/?token=${prefs.getString('token')}')
        .then((value) {
      if (value != null) {
        setState(() {
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      '${widget.carts.grandTotal} ${getTransrlate(context, 'Currency')} ',
                      style: TextStyle(fontWeight: FontWeight.w700),
                    ),
                  ],
                ),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      '${DefaultAddress == null ? 0 : DefaultAddress.total_delivery} ${getTransrlate(context, 'Currency')} ',
                      style: TextStyle(fontWeight: FontWeight.w700),
                    ),
                  ],
                ),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      '${widget.carts.grandTotal + (DefaultAddress == null ? 0 : DefaultAddress.total_delivery)} ${getTransrlate(context, 'Currency')} ',
                      style: TextStyle(fontWeight: FontWeight.w700),
                    ),
                  ],
                ),
